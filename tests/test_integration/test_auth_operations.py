...
from app.services.users import UserService, UserCreate, UserUpdate, UserResponse, UserAlreadyExistsError, UserNotFoundError, NoFieldsToUpdateError
...
class TestAuthOperations:
    ...
    def test_google_authentication_success(self, services, valid_user_data: UserCreate):
        ...
        result = user_service.google_authenticate_user(username=valid_user_data.username)
        assert result == True
        ...
        result = user_service.google_authenticate_user(google_id=valid_user_data.google_id)
        assert result == True
        
        # Test Google auth by phone_number
        result = user_service.google_authenticate_user(phone_number=valid_user_data.phone_number)
        assert result == True
    ...
    def test_user_update_edge_cases(self, services, valid_user_data: UserCreate):
        ...
        updated_user = user_service.update_user(
            ...
            UserUpdate(first_name="UpdatedFirst")
        )
    ...
    def test_user_exists_combinations(self, services, valid_user_data: UserCreate):
        ...
        assert user_service.user_exists(phone_number=valid_user_data.phone_number) == True
        ...
        assert user_service.user_exists(
            username=valid_user_data.username,
    ...
    def test_user_id_generation_uniqueness(self, services):
        ...
        for i in range(100):
            ...
            assert user_id not in generated_ids, f"Duplicate user ID generated: {user_id}"
    ...
    def test_timestamp_handling(self, services, valid_user_data: UserCreate):
        ...
        assert updated_user.last_updated_at != user_response.last_updated_at  # Should change