...
from app.services.users import UserCreate, UserResponse, UserService, UserUpdate, UserNotFoundError, UserAlreadyExistsError, NoFieldsToUpdateError
...
class TestUserCrud:
    ...
    def test_user_crud_exception_handling(self, user_service: UserService, user_create_data: UserCreate):
        ...
        with pytest.raises(UserNotFoundError, match="User not found"):
            user_service.update_user("nonexistent-user-id", UserUpdate(first_name="Test"))
