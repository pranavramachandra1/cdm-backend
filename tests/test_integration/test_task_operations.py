...
from app.services.task import TaskService, TaskCreate, TaskUpdate, TaskResponse, TaskNotFoundError, InvalidVersionRequest, NoFieldsToUpdateError, FailedToDeleteTaskError
...
class TestTaskOperations:
    ...
    def test_task_crud_operations(self, services, user_create_data: UserCreate):
        ...
        list_data = ListCreate(user_id=user_response.user_id, list_name="CRUD test list")
    ...
    def test_task_exceptions(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Exception test list")
        list_response = list_service.create_list(list_data=list_data)
    ...
    def test_task_toggle_operations(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Toggle test list")
        list_response = list_service.create_list(list_data=list_data)
    ...
    def test_task_versioning_edge_cases(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Version test list")
        list_response = list_service.create_list(list_data=list_data)
        ...
        version_1_tasks = task_service.get_current_tasks_from_list(list_response.list_id)
        ...
        version_0_tasks = task_service._get_tasks_from_list_version(list_response.list_id, 0)
    ...
    def test_task_duplication_edge_cases(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Duplication test list")
        list_response = list_service.create_list(list_data=list_data)
        ...
        tasks_config = [
            ...
            ("Recurring Non-Priority Complete", False, True, True), # Will be duplicated
            ("Non-Recurring Priority Complete", True, False, True), # Will NOT be duplicated
            ("Non-Recurring Priority Incomplete", True, False, False), # Will be duplicated
            ("Non-Recurring Non-Priority Complete", False, False, True), # Will NOT be duplicated
        ]
        ...
        for expected_name in expected_tasks:
            assert expected_name in rollover_names, f"Task '{expected_name}' should be duplicated in rollover"

        for not_expected_name in not_expected_tasks:
            assert not_expected_name not in rollover_names, f"Task '{not_expected_name}' should NOT be duplicated in rollover"
    ...
    def test_task_reminders_handling(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Reminder test list")
        list_response = list_service.create_list(list_data=list_data)
        ...
        assert len(duplicated_tasks[0].reminders) == 0  # Reminders cleared during duplication
    ...
    def test_task_update_edge_cases(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Update test list")
        list_response = list_service.create_list(list_data=list_data)
    ...
    def test_get_versions_of_list_pagination(self, services, user_create_data: UserCreate):
        ...
        user_response = user_service.create_user(user_data=user_create_data)
        list_data = ListCreate(user_id=user_response.user_id, list_name="Pagination test list")
        list_response = list_service.create_list(list_data=list_data)
