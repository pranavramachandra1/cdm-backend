...
class TestTaskService:
    ...
    def test_create_task_user_not_found(
        self, task_service, mock_user_service, mock_list_service, sample_task_create
    ):
        """
    ...
    def test_create_task_list_not_found(
        self, task_service, mock_user_service, mock_list_service, sample_task_create
    ):
        """
    ...
    def test_get_task_success(
        self, task_service, mock_task_collection, sample_task_doc
    ):
        """
    ...
    def test_update_task_success(
        self, task_service, mock_task_collection, mock_user_service, sample_task_doc
    ):
        """
    ...
    def test_toggle_completion_success(self, task_service, sample_task_doc):
        ...
        """
        with patch.object(task_service, "get_task") as mock_get_task, patch.object(
    ...
    def test_get_current_tasks_from_list(
        self, task_service, mock_task_collection, mock_list_service, sample_task_doc
    ):
        """
        ...
        mock_task_collection.find.assert_called_once_with(
            {"list_id": "list-123", "list_version": 2}
        )
    ...
    def test_clear_list_with_recurring_tasks_strategy4(
        self,
        task_service,
        mock_list_service,
        sample_recurring_task_doc,
        mock_task_collection,
    ):
        """
        ...
        """
        with patch.object(
            task_service, "get_current_tasks_from_list"
        ) as mock_get_tasks:
            ...
            assert (
                mock_get_tasks.call_count == 2
            ), "Should call get_current_tasks_from_list twice"
            ...
            mock_task_collection.find_one.assert_called_once_with(
                {"task_id": "task-789"}
            )
    ...
    def test_rollover_list_strategy4(
        self,
        task_service,
        mock_list_service,
        sample_recurring_task_doc,
