...
class TestUserService:
    ...
    def test_create_user_success(self, user_service, mock_collection, sample_user_create):
    ...
    def test_create_user_already_exists(self, user_service, mock_collection, sample_user_create):
    ...
    def test_get_user_success(self, user_service, mock_collection, sample_user_doc):
        ...
        mock_collection.find_one.assert_called_once_with({"user_id": "test-user-id-123"})
    ...
    def test_get_user_excludes_password(self, user_service, mock_collection, sample_user_doc):
    ...
    def test_update_user_no_fields(self, user_service, mock_collection, sample_user_doc):
    ...
    def test_delete_user_success(self, user_service, mock_collection, sample_user_doc):
        ...
        mock_collection.delete_one.assert_called_once_with({"user_id": "test-user-id-123"})
    ...
    def test_delete_user_database_failure(self, user_service, mock_collection, sample_user_doc):
        """Test database deletion failure"""
        mock_collection.find_one.return_value = sample_user_doc
        mock_collection.delete_one.return_value = Mock(deleted_count=0)  # Failed to delete
