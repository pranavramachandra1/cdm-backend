...
class TestListService:
    ...
    def test_create_list_success(self, list_service, mock_list_collection, sample_list_create):
        """
    ...
    def test_get_list_success(self, list_service, mock_list_collection, sample_list_doc):
    ...
    def test_update_list_success(self, list_service, mock_list_collection, sample_list_doc):
        """Test successful list update"""
        # Mock list exists
        mock_list_collection.find_one.side_effect = [
            sample_list_doc,  # First call for list_exists
            {**sample_list_doc, "list_name": "Updated List"}  # Second call for get_list
        ]
    ...
    def test_update_list_no_fields(self, list_service, mock_list_collection, sample_list_doc):
    ...
    def test_delete_list_success(self, list_service, mock_list_collection, sample_list_doc):
        ...
        mock_list_collection.delete_one.assert_called_once_with({
            "list_id": "list-123"
        })
    ...
    def test_delete_list_database_failure(self, list_service, mock_list_collection, sample_list_doc):
    ...
    def test_get_lists_by_user_success(self, list_service, mock_list_collection, mock_user_service):
        """
    ...
    def test_get_lists_by_user_empty_result(self, list_service, mock_list_collection, mock_user_service):
    ...
    def test_increment_version_success(self, list_service, mock_list_collection, sample_list_doc):
        """
